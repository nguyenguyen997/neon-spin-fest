  ...
  "rounded-xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        neon: "bg-card border-primary/30 shadow-[0_0_30px_hsl(343_100%_50%_/_0.15)]",
        "neon-cyan": "bg-card border-secondary/30 shadow-[0_0_30px_hsl(176_100%_46%_/_0.15)]",
        gradient: "bg-gradient-to-br from-card to-muted border-border/50",
        interactive: "bg-card border-border hover:border-primary/50 hover:shadow-[0_0_30px_hsl(343_100%_50%_/_0.2)] cursor-pointer",
      },
    },
    defaultVariants: {
      variant: "default",
